...
{
    const char* pszTimestamp = "Egypt EGY started 01/07/2022 in Mexico, Farid&Cecilia A. F. G. 1970/1975";
...
//        consensus.defaultAssumeValid = uint256S("0x1673fa904a93848eca83d5ca82c7af974511a7e640e22edc2976420744f2e56a"); //1155631
        ...
        genesis = CreateGenesisBlock(1658979937, 2000992896, 0x1e0ffff0, 1, 30 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xeb0a8cc0f4b49959790828b70fd7833c64d3e3c1c2863a29e524c85367d65d5c"));
        assert(genesis.hashMerkleRoot == uint256S("0xb614b93f99faaab558b6d899f1bd14a3e2288d4c69e95eb2293efa7bc5f5b791"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("165.232.150.161", "165.232.150.161", true));
...
//        vSeeds.push_back(CDNSSeedData("koin-project.com", "dnsseed.koin-project.com"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0xeb0a8cc0f4b49959790828b70fd7833c64d3e3c1c2863a29e524c85367d65d5c"))
...
//            (721000, uint256S("0x198a7b4de1df9478e2463bd99d75b714eab235a2e63e741641dc8a759a9840e5"))
        ...
        chainTxData = ChainTxData{
            ...
            1658979937, // * UNIX timestamp of last known number of transactions
...
//        consensus.defaultAssumeValid = uint256S("0x43a16a626ef2ffdbe928f2bc26dcd5475c6a1a04f9542dfc6a0a88e5fcf9bd4c"); //8711
        ...
        genesis = CreateGenesisBlock(1658979937, 1773428, 0x1e0ffff0, 1, 30 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xff3e23c3feb62f2ad8bbda56364b82be5caff39c0a018c8901db788f88a3240b"));
        assert(genesis.hashMerkleRoot == uint256S("0xb614b93f99faaab558b6d899f1bd14a3e2288d4c69e95eb2293efa7bc5f5b791"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("165.232.150.161", "165.232.150.161"));
...
//        vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed-testnet.thrasher.io", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0xff3e23c3feb62f2ad8bbda56364b82be5caff39c0a018c8901db788f88a3240b")),
        };
...
//        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nTimeout = 999999999999ULL;
        ...
        genesis = CreateGenesisBlock(1658979937, 0, 0x207fffff, 1, 30 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xc8b78504ca6f677cc6d9d716aba29b97c27d924ab1cb54025c4ee99f70be68e0"));
        assert(genesis.hashMerkleRoot == uint256S("0xb614b93f99faaab558b6d899f1bd14a3e2288d4c69e95eb2293efa7bc5f5b791"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0xc8b78504ca6f677cc6d9d716aba29b97c27d924ab1cb54025c4ee99f70be68e0"))
        };
