...
{
    const char* pszTimestamp = "Egypt EGY started 20/06/2022 in Mexico, Farid&Cecilia A. F. G. 1970/75";
...
//        consensus.defaultAssumeValid = uint256S("0x1673fa904a93848eca83d5ca82c7af974511a7e640e22edc2976420744f2e56a"); //1155631
        ...
        genesis = CreateGenesisBlock(1656728727, 2001242621, 0x1e0ffff0, 1, 30 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x401b95b355ab6b5be48a93cb5b79582dccb6ba8e0fb1db01914126b0b720d896"));
        assert(genesis.hashMerkleRoot == uint256S("0xcfcb10f2987c5b8f0aec535e4b379d123c4da7c27028e5f4527bc79a910d1dc8"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("143.198.141.229", "143.198.141.229", true));
...
//        vSeeds.push_back(CDNSSeedData("koin-project.com", "dnsseed.koin-project.com"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0x401b95b355ab6b5be48a93cb5b79582dccb6ba8e0fb1db01914126b0b720d896"))
...
//            (721000, uint256S("0x198a7b4de1df9478e2463bd99d75b714eab235a2e63e741641dc8a759a9840e5"))
        ...
        chainTxData = ChainTxData{
            ...
            1656728727, // * UNIX timestamp of last known number of transactions
...
//        consensus.defaultAssumeValid = uint256S("0x43a16a626ef2ffdbe928f2bc26dcd5475c6a1a04f9542dfc6a0a88e5fcf9bd4c"); //8711
        ...
        genesis = CreateGenesisBlock(1656728727, 818311, 0x1e0ffff0, 1, 30 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x5a162b39adb97f565452ba596036e34119abcedd5bd093d3830d44defecc79b7"));
        assert(genesis.hashMerkleRoot == uint256S("0xcfcb10f2987c5b8f0aec535e4b379d123c4da7c27028e5f4527bc79a910d1dc8"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("143.198.141.229", "143.198.141.229"));
...
//        vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed-testnet.thrasher.io", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x5a162b39adb97f565452ba596036e34119abcedd5bd093d3830d44defecc79b7")),
        };
...
//        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nTimeout = 999999999999ULL;
        ...
        genesis = CreateGenesisBlock(1656728727, 1, 0x207fffff, 1, 30 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x52e015b6c7a74d6f5a0874cd24430c48b8c7cb1d600719f6ebc586e2e7e58ea4"));
        assert(genesis.hashMerkleRoot == uint256S("0xcfcb10f2987c5b8f0aec535e4b379d123c4da7c27028e5f4527bc79a910d1dc8"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x52e015b6c7a74d6f5a0874cd24430c48b8c7cb1d600719f6ebc586e2e7e58ea4"))
        };
